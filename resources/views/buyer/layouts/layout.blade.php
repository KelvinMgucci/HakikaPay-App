...
<head>
  ...
  <title>@yield('buyer_page_title')</title>
...
<body>
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link {{ Request::is('buyer/dashboard') ? '' : 'collapsed' }}" href="{{ route('dashboard') }}">
    ...
    <li class="nav-item">
      <a class="nav-link {{ Request::is('buyer/escrows*') ? '' : 'collapsed' }}" href="{{ route('buyer.escrows.view') }}">
    ...
    <li class="nav-item">
      <a class="nav-link {{ Request::is('buyer/orders*') ? '' : 'collapsed' }}" href="{{ route('buyer.orders.orders') }}">
    ...
    <li class="nav-item">
      <a class="nav-link {{ Request::is('buyer/disputes*') ? '' : 'collapsed' }}" href="{{ route('buyer.disputes.view') }}">
    ...
    <li class="nav-item">
      <a class="nav-link {{ Request::is('buyer/notifications') ? '' : 'collapsed' }}" href="{{ route('buyer.notifications.view') }}">
        <i class="bi bi-bell"></i>
    ...
    <li class="nav-item">
      <a class="nav-link {{ Request::is('buyer/settings*') ? '' : 'collapsed' }}" href="{{ route('buyer.settings.view') }}">
        <i class="bi bi-gear"></i>
        <span>Settings</span>
      </a>
    </li><!-- End Settings Nav -->
